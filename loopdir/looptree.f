      subroutine    looptree(idi,idel,nato,nmo,ndeloc,iperm,nindex,itmo,
     .                       nproc,icodepar ,matnperm,moc,s,deloc,debug)
C
C-----------------------------------------------------------------------
...
c     rnucchar(0)= 0.0
C***********************************************************************
      if (debug) print *,'In SUBROUTINE looptree :',idi,idel,nato,nmo,nd
     .eloc,iperm,nindex,itmo,icodepar ,matnperm,'moc','s',deloc,debug
      if (debug) print *,'                          idi,idel,nato,nmo,nd
     .eloc,iperm,nindex,itmo,icodepar ,matnperm, moc , s ,deloc,debug'
C
...
C
 105  continue
            call       looporb5(idi,idel,nato,nmo,ndeloc,iperm,nindex,
     .                   nproc,icodepar,itmo,matnperm,moc,s,deloc,debug)
      goto 100
C
 106  continue
            call       looporb6(idi,idel,nato,nmo,ndeloc,iperm,nindex,
     .                   nproc,icodepar,itmo,matnperm,moc,s,deloc,debug)
      goto 100
C
 107  continue
