C=======================================================================
C
      subroutine       looporb10(idi,idel,nato,nmo,ndeloc,iperm,nindex,
...
C$OMP&            private(iom,jom,kom,lom,mom,nom,iiom,ijom,ikom,ilom)
...
C >>>     Deloc Calculation <<<
     ...
     +                        * s(matper( 9),moc(ikom),moc(ilom)) !! 9
     +                        * s(matper(10),moc(ilom),moc(iom) ) !!10
C >>> END Deloc Calculation <<<
                                 enddo !! ilom =1,itmo !!10
                              enddo !! ikom =1,itmo    !! 9
                           enddo !! ijom =1,itmo       !! 8
                        enddo !! iiom =1,itmo          !! 7
                     enddo !! nom =1,itmo              !! 6
