C=======================================================================
C
      subroutine       looporb14(idi,idel,nato,nmo,ndeloc,iperm,nindex,
...
C$OMP&          private(iom,jom,kom,lom,mom,nom,ii,ij,ik,il,im,ji,jj,jk)
...
C >>>     Deloc Calculation <<<
     ...
     +                        * s(matper(12),moc(ji)  ,moc(jj)  )  !!12
     +                        * s(matper(13),moc(jj)  ,moc(jk)  )  !!13
     +                        * s(matper(14),moc(jk)  ,moc(iom) )  !!14
